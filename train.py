...
if __name__ == "__main__":
    ...
    network = DeepLabV3(model_id, project_dir="/root/autodl-tmp/deeplabv3")#.cuda()
    
    network.load_state_dict(torch.load("/root/autodl-tmp/deeplabv3/training_logs/model_1/checkpoints/model_1_epoch_200.pth"))##
